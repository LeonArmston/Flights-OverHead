...
class FlightRadar24API:
    ...
    def get_flights_overhead(self, latitude: float, longitude: float, distance_m: float) -> dict[str, Any]:
        ...
        try:
            ...
            for flight_id, flight_data in data.items():
                ...
                try:
                    ...
                    _LOGGER.debug("Error processing flight data for %s: %s", flight_id, e)
                    continue
            ...
            _LOGGER.error("Error fetching flight data: %s", e)
